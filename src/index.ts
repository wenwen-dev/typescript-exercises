...
// console.log(aUser.address.street ?? undefined);
console.log(aUser?.address?.street);
...
//type narrowing, if it is a string, then can use string method
